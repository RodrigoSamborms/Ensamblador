...
Principal:
printn ""
printn "Alumno: Rodrigo Torres Rivera"
lea si,buffer
call print_string
printn ""
printn "La cadena a procesar debe tener maximo 20 caracteres"
lea si,buffer
call print_string
printn ""
printn "los datos deben ir en el formato: digito operador digito sin espacios"
lea si,buffer
call print_string
printn ""
;esciribir cadenas version corta
printn "Escriba la cadena a procesar:"
