...
nueva_linea     db 1    ; Bandera: 1 = Imprimir contador al inicio de l�nea, 0 = No imprimir
...
MOV AX, BX ;Recuperamos el residuo anterior (lo que qued� de las centenas)
...
activar_nueva_linea:
MOV nueva_linea, 1      ; Activamos la bandera para la siguiente l�nea
